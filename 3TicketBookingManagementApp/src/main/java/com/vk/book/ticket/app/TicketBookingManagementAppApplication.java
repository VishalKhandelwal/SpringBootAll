package com.vk.book.ticket.app;
...
import com.vk.book.ticket.app.service.TicketBookingService;
...
public class TicketBookingManagementAppApplication {
	...
	public static void main(String[] args) {
       ...
       // TicketBookingService ticketBookingService = applicationContext.getBean("ticketBookingService", TicketBookingService.class);
		 ...
		 * ticket.setDestStation("Mumbai"); ticket.setSourceStation("Pune");
		 * ticket.setPassengerName("KK"); ticket.setEmail("kk@yahoo.com");
		 * 
